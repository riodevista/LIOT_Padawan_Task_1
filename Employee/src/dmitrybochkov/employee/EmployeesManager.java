...
class EmployeesManager {
    ...
    public static void inputOneEmployee(final EmployeesContainer employeesContainer){
        ...
        String name = System.console().readLine(); //“олько в консоли работает.
    ...
    private static void outputEmployee(final Employee employee){
        //«десь надо что-то с ресурсами мутить, а то с локализацией проблемы и т.п., не хардкодить ведь.
        String position = "no position";
        switch (employee.getPosition()) { //Ќадо было сразу список позиций делать, а то это не оч, что € сейчас творю.
